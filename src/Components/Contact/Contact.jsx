  ...
  return (
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                <li> <img src={mail_icon} alt="" />meshram.harsh05@gmail.com</li>
                <li><img src={phone_icon} alt="" />+91 7499288828</li>
                <li><img src={location_icon} alt="" />House no. 1 - Indra Nagar, dighori, Nagpur <br /> 440036, India</li>
            </ul>
        </div>
        <div className="contact-col">
